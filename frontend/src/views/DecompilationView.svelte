...
<script>
    ...
    function get_decompilation(){
        ...
        if("ofrak.model._auto_attributes.AttributesType[AngrDecompilationAnalysisResource]" in $selectedResource.attributes){
            var html =  hljs.highlight($selectedResource.attributes["ofrak.model._auto_attributes.AttributesType[AngrDecompilationAnalysisResource]"]["decompilation"],
            { language: 'c' }).value
            return html;
        } else {
