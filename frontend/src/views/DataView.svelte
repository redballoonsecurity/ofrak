...
<div class="content">
    ...
    <div class="tabs">
        <button on:click={(e) => {display_type="hex"}}>Hex</button>
        {#if hasTextView}
        <button on:click={(e) => {display_type="text"}}>Text</button>
        {/if}
        {#if hasAsmView}
        <button on:click={(e) => {display_type="asm"}}>Asm</button>
        {/if}
        {#if hasDecompView}
        <button on:click={(e) => {display_type="decomp"}}>Decompilation</button>
        {/if}
    </div>
    {#if display_type == "hex"}
