...
def main(ofrak_context: OFRAKContext, in_file: str, out_file: str):
    # Create root resource and tag
    root_resource = ofrak_context.create_root_resource_from_file(in_file)
    ...
    root_resource.flush_data_to_disk(out_file)
