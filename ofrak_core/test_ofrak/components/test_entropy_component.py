...
def test_analyzer(ofrak_context: OFRAKContext, test_file_path):
    """
    ...
    root = ofrak_context.create_root_resource_from_file(test_file_path)
    root.run(DataSummaryAnalyzer)
