...
class FreeSpaceAnalyzerTestCase:
    ...
    def inflate(self, ofrak_context: OFRAKContext) -> Resource:
        return inflate_tree(self.tree_structure, ofrak_context)
...
def test_free_space_analyzer(ofrak_context: OFRAKContext, test_case: FreeSpaceAnalyzerTestCase):
    allocatable_r = test_case.inflate(ofrak_context)
    allocatable = allocatable_r.view_as(Allocatable)
...
def test_free_space_analysis_of_non_memory_region(
    ...
    child_1 = root_r.create_child_from_view(
    ...
    child_2 = root_r.create_child_from_view(
    ...
    allocatable = root_r.view_as(Allocatable)
