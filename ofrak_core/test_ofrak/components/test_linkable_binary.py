...
from ofrak.core import LinkableBinary, LinkableSymbol, LinkableSymbolType


@pytest.fixture
async def linkable_binary(ofrak_context: OFRAKContext) -> LinkableBinary:
...
async def test_get_symbol(linkable_binary: LinkableBinary):
    """
...
async def test_duplicate_symbol(linkable_binary: LinkableBinary):
    """
...
async def test_nonexistent_symbol(linkable_binary: LinkableBinary):
    """
...
async def test_no_args(linkable_binary: LinkableBinary):
    """
