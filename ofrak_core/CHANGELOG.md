...
### Changed
- Changed the `CpioUnpacker` to use `7z` instead of the `cpio` utility due to `cpio` failing when extracting absolute paths. [#276](https://github.com/redballoonsecurity/ofrak/pull/276)
