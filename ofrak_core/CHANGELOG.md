...
- A new feature that allows users to create an OFRAK "project" that contains a collection of scripts and binaries. ([#358](https://github.com/redballoonsecurity/ofrak/pull/358))
