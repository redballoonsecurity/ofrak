...
- Fix off-by-one in `RemoveFreeSpaceModifier` preventing allocation of the last byte of a free space range. ([#754](https://github.com/redballoonsecurity/ofrak/pull/754))
